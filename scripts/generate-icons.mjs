...
//   icon-512-maskable.png        — logo at 80% on a marigold safe-zone so the
//                                  wordmark survives Android's adaptive crop
...
await sharp({ create: { width: 512, height: 512, channels: 4, background: MARIGOLD } })
